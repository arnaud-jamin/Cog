...
namespace Cog::ImguiInterops
{
	...
	/*
	 *Disabled gamepad for now
	void SetGamepadNavigationKey(Cog::ImguiInterops::ImGuiTypes::FNavInputArray& NavInputs, const FKey& Key, bool bIsDown)
	{
	...
	*/
	...
	void CopyInput(ImGuiIO& IO, const FCogImguiInputState& InputState, const FCogImguiContext& CogContext)
	{
		...
		*/
		...
		for (const auto& MouseButtonEvent : InputState.GetMouseButtonEvents())
		{
			IO.AddMouseSourceEvent(ImGuiMouseSource_Mouse);
			IO.AddMouseButtonEvent(MouseButtonEvent.ButtonId, MouseButtonEvent.Down);
		}
